  ...
  return (
    <>
      <div className="prose-config">
        ...
        <p>
          Starting new?{" "}
          <Anchor href="https://github.com/dogokit/dogokit-beagle/generate">
            Use this GitHub repo template to generate the repository
          </Anchor>
          .
        </p>
        <p>Clone with Git?</p>
        <pre>git clone git@github.com:dogokit/dogokit-beagle.git</pre>
        <p>
          Create with <code>pnpx</code> or <code>pnpm dlx</code>?
        </p>
        <pre>pnpx create-remix@latest --template dogokit/dogokit-beagle</pre>
        <p>
